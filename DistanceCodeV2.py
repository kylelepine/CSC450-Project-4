...
while(1):
    ...
    startupBuffer += 1   
    frameCounter += 1
    if (startupBuffer > 100 and frameCounter % 2 == 0):
        ...
        if len(contours) != 0:
            ...
            if(boxArea > minArea):
                ...
                if(distance == 5):
                    crop_frame = testmask[y:(y+h), x:(x+250)]
                if(distance == 10):
                    crop_frame = testmask[y:(y+h), x:(x+120)]
                if(distance == 15):
                    crop_frame = testmask[y:(y+h), x:(x+100)]
                if(distance == 20):
                    crop_frame = testmask[y:(y+h), x:(x+60)]
                if(distance == 25):
                    crop_frame = testmask[y:(y+h), x:(x+40)]   
                if(distance == 30):
